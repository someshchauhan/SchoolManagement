<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="principal.aspx.cs" Inherits="SchoolManagement.principal" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="main">
                ...
                <div class="btn1" id="btn1" runat="server">
                    <asp:Button ID="Button1" runat="server" Text="Principals info" OnClick="Button1_Click" />
                </div>
